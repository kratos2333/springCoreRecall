...
import com.kevin.purxmlconfig.Student;
import com.kevin.purxmlconfig.Teacher;

public class TestPureXMLConfigurationClient {

	public static void main(String[] args) {
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("applicationContextWithPureXML.xml");
